...
import { motion, easeInOut, easeOut, scale } from 'framer-motion'
...
export default function Home() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <main className="flex flex-col items-center justify-center text-center pt-8 sm:pt-16 pb-32 px-4">
        ...
        >
          ...
          <motion.div className="relative z-10">
            ...
            <motion.div className='text-4xl sm:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-tight mb-6'
              variants={fadeSlideUp}
            ...
            <div
              className="text-md sm:text-xl text-gray-600 max-w-xl mx-auto mb-10 sm:mb-12 min-h-[3.5em]" // Added min-height to prevent layout shift
            ...
            >
              ...
              <motion.div
                ...
                className="flex justify-center px-8 py-4 bg-linear-to-r from-green-400 to-teal-500 text-white font-semibold text-lg rounded-xl shadow-lg md:items-center hover:shadow-xl transform transition duration-500 ease-in-out max-w-2xl"
